...
class TestPromptLengthValidation:
    ...
    def test_validate_prompt_length_normal_prompt(self):
        ...
        # Normal prompt: 1000 chars ≈ 1000 tokens (well within 8192 limit)
        prompt = "x" * 1000
    ...
    def test_validate_prompt_length_exceeds_context_window(self):
        ...
        # Large prompt: 10000 chars ≈ 10000 tokens (exceeds 8192 limit)
        huge_prompt = "x" * 10000
    ...
    def test_validate_prompt_length_error_message_content(self):
        ...
        huge_prompt = "x" * 10000  # 40000 chars ≈ 10000 tokens
        ...
        assert "10000 characters" in error, "Should show actual character count"
    ...
    def test_validate_prompt_length_at_boundary(self):
        ...
        # Exactly 8192 tokens = 8192 characters
        boundary_prompt = "x" * 8192
    ...
    def test_validate_prompt_length_one_over_boundary(self):
        ...
        # 8193 tokens = 8193 characters (1 token over limit)
        over_boundary_prompt = "x" * 8193
    ...
    def test_validate_prompt_length_small_context_window(self):
        ...
        # 100 chars ≈ 100 tokens (within 128 limit)
        small_prompt = "x" * 100
        config.validate_prompt_length(small_prompt)

        # 1000 chars ≈ 1000 tokens (exceeds 128 limit)
        large_prompt = "x" * 1000
    ...
    def test_validate_prompt_length_large_context_window(self):
        ...
        # Very large prompt: 100000 chars ≈ 100000 tokens (well within 1M limit)
        large_prompt = "x" * 100000
        config.validate_prompt_length(large_prompt)

        # Extremely large prompt: 5000000 chars ≈ 5000000 tokens (exceeds 1M)
...
class TestPromptLengthValidationErrorMessages:
    ...
    def test_error_message_different_limits(self):
        ...
        huge_prompt = "x" * 10000  # 10000 tokens
...
class TestPromptLengthValidationIntegration:
    ...
    def test_validate_prompt_length_consistency(self):
        ...
        prompt = "x" * 1000  # 1000 tokens, within limit
        ...
        huge_prompt = "x" * 10000  # 10000 tokens, over limit
