"""Custom exception types for programmatic CLI evaluation API.

This module defines exception types that replace sys.exit() calls in the programmatic
evaluate_submission() function, enabling structured error handling for callers.
"""
